import { format, parseISO, isToday, isFuture, isPast, startOfDay, endOfDay } from 'date-fns'
...
export const validateTodoContents = (contents: string): boolean => {
  return contents.length <= APP_CONSTANTS.MAX_TODO_CONTENTS && contents.length > 0
}
