import { Journal, Todo, Category, Profile, Settings, Image, Anniversary, Weather, Feeling, TodoStatus, AnniversaryType, AnniversaryWeight, FontType } from '@/types'
...
export const sampleJournals: Journal[] = [
  {
    ...
    contents: '오늘은 정말 좋은 하루였다. 아침에 일찍 일어나서 산책을 다녀왔고, 점심에는 맛있는 음식을 먹었다. 오후에는 친구들과 만나서 즐거운 시간을 보냈다.',
    saved: true,
    locked: false,
  ...
  },
  {
    ...
    contents: '오늘은 집에서 책을 읽으며 평온한 시간을 보냈다. 비가 올 것 같았지만 다행히 오지 않아서 산책도 할 수 있었다.',
    saved: true,
    locked: false,
  ...
  },
  {
    ...
    contents: '오늘은 하루 종일 비가 와서 집에만 있었다. 우울한 기분이었지만 집에서 영화를 보며 시간을 보냈다.',
    saved: true,
    locked: false,
